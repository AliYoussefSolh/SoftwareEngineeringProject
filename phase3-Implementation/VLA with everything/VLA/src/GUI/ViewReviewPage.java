...
public class ViewReviewPage extends JFrame{
	private JLabel nothingHere;
	static JLabel[] RatingButtons;
	
	public ViewReviewPage(Student s, SelectViewReviewCourses svrc, Course c) throws NumberFormatException, FileNotFoundException, 
	ParseException, InvalidRatingValueException, InvalidEmailException {
		ArrayList<Review> Allreviews = Database.selectInstructorReviews(c.getProfessor());
